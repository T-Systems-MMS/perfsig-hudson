 ...
 */
public class InterfaceTestCase extends GeneralTestCase {

    @DataBoundConstructor
    public InterfaceTestCase(final String name, final List<Dashboard> singleDashboards, final List<Dashboard> comparisonDashboards, final String xmlDashboard) {
