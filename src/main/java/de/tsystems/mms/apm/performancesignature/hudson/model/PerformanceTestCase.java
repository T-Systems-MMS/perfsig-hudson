...
package de.tsystems.mms.apm.performancesignature.hudson.model;
 ...
 */
public class PerformanceTestCase extends GeneralTestCase {

    @DataBoundConstructor
    public PerformanceTestCase(final String name, final List<Dashboard> singleDashboards, final List<Dashboard> comparisonDashboards, final String xmlDashboard) {
