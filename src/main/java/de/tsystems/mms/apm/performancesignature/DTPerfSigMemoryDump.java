...
public class DTPerfSigMemoryDump extends Builder {
    ...
    public DTPerfSigMemoryDump(final String agent, final String host, final String type, final boolean lockSession, final boolean captureStrings,
    ...
    public boolean perform(final AbstractBuild build, final Launcher launcher, final BuildListener listener) {
        ...
        final DTServerConnection connection = new DTServerConnection(dtRecorder.getProtocol(), dtRecorder.getHost(), dtRecorder.getPort(), dtRecorder.getUsername(),
                dtRecorder.getPassword(), dtRecorder.isVerifyCertificate(), dtRecorder.isUseJenkinsProxy(), dtRecorder.getCustomProxy());
